...
- **Resume restructured for applications (`02471f7`).** Added a dated **Experience** section (*Freelance & Independent Full-Stack Developer, 2024–Present*) framing the Luxury Solutions client work + the independent products as real, timelined work; added a **Remote · Canada** location and a summary that leads with shipped proof. (An Education line was briefly added then **removed at Zack's request** — his freeCodeCamp credits are self-paced certs and he prefers the projects to speak; do not re-add an Education section.) Dropped the two weakest Additional Projects (Volume Booster, the duplicate Daily 60 Base44 PWA) and tightened CSS density so the PDF stays **one page** (verified by page-count + on-screen overflow measurement). md / html / pdf kept in parity.
